  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={[styles.title, { color: colors.foreground }]}>Sign in to{`\n`}your atelier.</Text>
        ...
        <View style={styles.footRow}>
          <Text style={[styles.footText, { color: colors.mutedForeground }]}>New to Veloura?</Text>
          <Link href="/(auth)/signup" replace asChild>
            <Pressable hitSlop={8}>
              <Text style={[styles.footLink, { color: colors.foreground }]}>Create an account</Text>
            </Pressable>
          </Link>
        </View>
      </ScrollView>
...
const styles = StyleSheet.create({
  ...
  title: { fontFamily: "Inter_700Bold", fontSize: 34, letterSpacing: -1.2, lineHeight: 40 },
